...
// */
//package com.zrsf.push.xmpp.presence;
//
...
//     */
//    public boolean isAvailable(UserVO user) {
//        return sessionManager.getSession(user.getSWRY_GH()) != null;
//    }
//
//    /**
...
//     */
//    public Presence getPresence(UserVO user) {
//        if (user == null) {
//            return null;
//        }
//        Presence presence = null;
//        ClientSession session = sessionManager.getSession(user.getSWRY_GH());
//        if (session != null) {
