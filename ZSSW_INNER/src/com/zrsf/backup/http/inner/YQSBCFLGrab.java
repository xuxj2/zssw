...
public class YQSBCFLGrab extends ZGSJGrab {
	private final String functionid = "47502";
	...
	public String getReportResponseHtml(String swjgl0, String swjgl1,
		...
		nps[3] = new NameValuePair("functionid", functionid);// 47502 //43078
		...
		nps[18] = new NameValuePair("gridfield_47502_dimn_0", "");
		nps[19] = new NameValuePair("chartfield_47502_dimn_0", "");
		nps[20] = new NameValuePair("viewstyle_47502_dimn_0", "0");
